package ru.alexk.MySecondTetsAppSpringBoot.controller;
...
import ru.alexk.MySecondTetsAppSpringBoot.service.*;
...
import ru.alexk.MySecondTetsAppSpringBoot.model.*;
...
public class MyController {
    ...
    public ResponseEntity<Response> feedback(@Valid @RequestBody Request request,
        ...
        Response response = Response.builder()
                ...
                .systemTime(String.valueOf(request.getSystemName()))
